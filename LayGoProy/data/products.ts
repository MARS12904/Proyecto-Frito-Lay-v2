...
export const products: Product[] = [
  ...
  },
  {
    ...
    isAvailable: true,
    isWholesale: true,
    tags: ['barbacoa', 'edicion-limitada', 'papas', 'nuevo'],
  ...
  },
  {
    ...
    wholesalePrice: 3.30,
    image: getProductImage('lays-clasico-150g'),
    description: 'Papas fritas con refrescante sabor a limón.',
    weight: '150g',
    unit: 'bolsa',
    stock: 280,
    minOrderQuantity: 12,
  ...
  },
  {
    ...
    wholesalePrice: 3.30,
    image: getProductImage('lays-queso-150g'),
    description: 'Papas fritas con sabor a ketchup.',
    weight: '150g',
    unit: 'bolsa',
    stock: 250,
    minOrderQuantity: 12,
  ...
  {
    id: 'lays-artesanal-150g',
    name: 'Lay\'s Artesanal',
    brand: 'Lay\'s',
    category: 'papas',
    ...
    wholesalePrice: 3.60,
    image: getProductImage('lays-clasico-150g'),
    description: 'Papas artesanales con sal de mar.',
    weight: '150g',
    unit: 'bolsa',
    stock: 180,
    minOrderQuantity: 12,
    ...
    isAvailable: true,
    isWholesale: true,
    tags: ['artesanal', 'papas', 'nuevo'],
    promotion: { type: 'discount', value: 15, description: '-15%' },
  },
  ...
  },
  {
    ...
    wholesalePrice: 3.60,
    image: getProductImage('doritos-nacho-cheese-145g'),
    description: 'Tortillas tridimensionales sabor queso.',
    weight: '145g',
    unit: 'bolsa',
    stock: 310,
    minOrderQuantity: 12,
  ...
  {
    id: 'cheese-tris-picante-150g',
    name: 'Cheese Tris Picante',
    brand: 'Cheese Tris',
    category: 'cheese-tris',
    subcategory: 'picante',
    price: 4.00,
  ...
  {
    id: 'piqueo-snax-queso-145g',
    name: 'Piqueo Snax Queso',
    brand: 'Piqueo Snax',
    category: 'piqueo',
    subcategory: 'queso',
    price: 5.00,
    wholesalePrice: 4.00,
    image: getProductImage('piqueo-snax-mix-clasico-145g'),
    description: 'Mix de snacks sabor queso.',
    weight: '145g',
    unit: 'bolsa',
    stock: 190,
    minOrderQuantity: 12,
    ...
    isAvailable: true,
    isWholesale: true,
    tags: ['queso', 'mix', 'nuevo'],
    promotion: { type: 'bulk', value: 20, description: '2x1' },
  },

        ...
        {assignment && (
          <div className="bg-background rounded-lg p-4 mb-6">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h2 className="text-lg font-semibold text-text">Repartidor Asignado</h2>
            </div>
            <div className="space-y-2 text-sm">
              <div>
                <span className="text-text-secondary">Nombre: </span>
                <span className="text-text font-medium">
                  {assignment.user_profiles?.name || 'N/A'}
                </span>
              </div>
              {assignment.user_profiles?.email && (
                <div>
                  <span className="text-text-secondary">Email: </span>
                  <span className="text-text">{assignment.user_profiles.email}</span>
                </div>
              )}
              {assignment.user_profiles?.phone && (
                <div>
                  <span className="text-text-secondary">Teléfono: </span>
                  <span className="text-text">{assignment.user_profiles.phone}</span>
                </div>
              )}
              {assignment.status && (
                <div>
              ...
              <tbody>
                {itemsWithProducts.map((item: any) => (
                  <tr key={item.id} className="border-b border-border">
                    ...
                    <td className="px-4 py-3 text-sm text-text">{item.quantity}</td>
